...
Plugin::load('CakeBootstrap', ['routes' => true]);

Plugin::load('CakeFontAwesome', ['routes' => true]);

Plugin::load('CakeAuth', ['routes' => true]);

Plugin::load('CakeContent', ['routes' => true]);

Plugin::load('CakeTaxonomy', ['routes' => true]);

Plugin::load('CakeFile', ['routes' => true]);

Plugin::load('CakeUtility', ['routes' => true]);
